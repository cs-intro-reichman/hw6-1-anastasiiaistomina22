 ...
 * For example, to morph the cake into its grescaled version. in 50 steps, use:
...
public class Editor4 {
	...
	public static void main (String[] args) {
        ...
        Color[][] imageOut = Runigram.grayScaled(sourceImage);;

		Runigram.setCanvas(sourceImage);
		Runigram.morph(sourceImage, imageOut, n);
	}
}